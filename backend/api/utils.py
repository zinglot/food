...
def create_ingredients(ingredients, recipe):
    """A function for adding ingredients.
       It is used when creating/editing a recipe."""
    ingredient_list = []
...
def create_model_instance(request, instance, serializer_name):
    """A function for adding a recipe to favorites or a shopping list."""
...
def delete_model_instance(request, model_name, instance, error_message):
    """A function for deleting a recipe
     from favorites or from a shopping list."""
